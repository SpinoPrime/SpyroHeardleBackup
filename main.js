var app = (function () {
  ...
  function Nt(t) {
    ...
    return {
      c() {
        (n = w("div")),
          (n.innerHTML =
            '<p class="mb-3">A clone of <a href="https://www.heardle.app/" title="Heardle">Heardle</a> but for PS1 Spyro songs. Each song is randomly chosen from his discography, including features.</p> \n\n<p class="mb-3">Made by <a href="https://twitter.com/colossussteppes">@colossussteppes</a>. All copyright goes to Insomniac, Stewart Copeland, and other relevant parties.</p> \n\n\n\n <p class="mb-3">  </p>  \n\n\n\n <p class="text-xs mb-3 text-custom-line">Prepared with <a href="https://developers.soundcloud.com">SoundCloud</a>\n and powered by <a href="https://glitch.com/">Glitch</a>. See the source code <a href="https://glitch.com/edit/#!/spyro-classic-heardle">here</a>.'),
          M(n, "class", "text");
      },
      m(e, t) {
        g(e, n, t);
      ...
      (O = new Rt({})),
      {
        c() {
          ...
          (o = x()),
            ...
            (m = w("div")),
            (k = w("div")),
            (k.textContent = "Next Spyro song in:"),
            (b = x()),
            Q(S.$$.fragment),
            (D = x()),
            (T = w("div")),
  ...
  function an(e) {
    ...
    return {
      c() {
        (t = _("You got today's Spyro Heardle within the first ")),
          (n = _(s)),
          (r = _(" seconds."));
      },
      m(e, s) {
  ...
  function ln(e) {
    ...
    return {
      c() {
        (t = _("You got today's Spyro Heardle within ")),
          (n = _(o)),
          (r = _("\n                second")),
          (s = _(a)),
          (i = _("."));
  ...
  function un(t) {
    ...
    return {
      c() {
        n = _("You didn't get today's Spyro Heardle. Better luck tomorrow!");
      },
      m(e, t) {
        g(e, n, t);
      },
        ...
        () => {
          ...
          for (let e = 0; e < i.maxAttempts; e++)
            r.length > e
              ...
              : (t += "⬜️");
          let o =
            e + "\n\n" + t + "\n\n" + "https://spyro-classic-heardle.glitch.me/";
          if (
            !navigator.share ||
  ...
  const Cn = ue([
      "Spyro 1 - Twilight Harbor",
      "Spyro 1 - Lofty Castle",
      "Spyro 2 - Sunny Beach",
      "Spyro 1 - Artisans",
      "Spyro 3 - Cloud Spires",
      "Spyro 1 - Alpine Ridge",
      "Spyro 2 - Title Screen + Glimmer",
      "Spyro 3 - Sorceress’s Lair (Greatest Hits)",
      "Spyro 1 - Dry Canyon",
      "Spyro 1 - Beast Makers",
      "Spyro 2 - Skelos Badlands",
      "Spyro 1 - Gnasty Gnorc",
      "Spyro 2 - Breeze Harbor (Trolley Trouble)",
      "Spyro 3 - Fireworks Factory",
      "Spyro 3 - Icy Peak",
      "Spyro 3 - Sunrise Spring",
      "Spyro 2 - Scorch",
      "Spyro 3 - Sgt Byrd’s Base + Enchanted Towers",
      "Spyro 3 - Haunted Tomb (Greatest Hits)",
      "Spyro 1 - Crystal Flight",
      "Spyro 3 - Bentley’s Outpost",
      "Spyro 1 - Dream Weavers",
      "Spyro 1 - Sunny Flight",
      "Spyro 3 - Enchanted Towers (Lost Wolf & Skateboarding)",
      "Spyro 3 - Country Speedway (Greatest Hits)",
      "Spyro 3 - Sunny Villa",
      "Spyro 2 - Dragon Shores",
      "Spyro 1 - Gnorc Cove",
      "Spyro 2 - Crush’s Dungeon",
      "Spyro 3 - Bamboo Terrace",
      "Spyro 1 - Magic Crafters",
      "Spyro 2 - Cloud Temples",
      "Spyro 2 - Robotica Farms",
      "Spyro 2 - Ocean Speedway",
      "Spyro 1 - Haunted Towers",
      "Spyro 1 - Ice Cavern",
      "Spyro 1 - Blowhard",
      "Spyro 3 - Evening Lake (Greatest Hits)",
      "Spyro 3 - Lost Fleet (Greatest Hits)",
      "Spyro 3 - Super Bonus Round",
      "Spyro 2 - Gulp’s Overlook",
      "Spyro 3 - Seashell Shore",
      "Spyro 3 - Dino Mines (Greatest Hits)",
      "Spyro 1 - Stone Hill",
      "Spyro 1 - Metalhead",
      "Spyro 3 - Honey Speedway (Greatest Hits)",
      "Spyro 2 - Zephyr",
      "Spyro 2 - Canyon Speedway",
      "Spyro 1 - Town Square",
      "Spyro Trilogy - Credits",
      "Spyro 1 - Jacques",
      "Spyro 1 - Dr Shemp",
      "Spyro 1 - Cliff Town",
      "Spyro 2 - Mystic Marsh",
      "Spyro 1 - Gnasty’s Loot",
      "Spyro 3 - Spike’s Arena",
      "Spyro 2 - Breeze Harbor",
      "Spyro 3 - Buzz’s Dungeon",
      "Spyro 3 - Scorch's Pit",
      "Spyro 1 - Dark Hollow",
      "Spyro 1 - Peace Keepers",
      "Spyro 3 - Molten Crater",
      "Spyro 3 - Mushroom Speedway (Greatest Hits)",
      "Spyro 1 - High Caves (NTSC)",
      "Spyro 2 - Icy Speedway",
      "Spyro 2 - Metropolis",
      "Spyro 2 - Magma Cone (Crystal Popcorn)",
      "Spyro 1 - Terrace Village",
      "Spyro 2 - Shady Oasis",
      "Spyro 3 - Icy Peak (Nancy)",
      "Spyro 2 - Aquaria Towers",
      "Spyro 3 - Harbor Speedway",
      "Spyro 1 - Wild Flight",
      "Spyro 2 - Ripto’s Arena (NTSC)",
      "Spyro 2 - Metro Speedway",
      "Spyro 3 - Agent 9’s Lab",
      "Spyro 3 - Midday Gardens",
      "Spyro 3 - Midnight Mountain",
      "Spyro 3 - Desert Ruins",
      "Spyro 1 - Title Screen",
      "Spyro 2 - Idol Springs + Fracture Hills",
      "Spyro 2 - Cloud Temples (Agent Zero)",
      "Spyro 2 - Crystal Glacier",
      "Spyro 2 - Colossus (Hockey)",
      "Spyro 1 - Tree Tops",
      "Spyro 3 - Title Screen + Sparx Levels",
      "Spyro 3 - Frozen Altars",
      "Spyro 2 - Colossus",
      "Spyro 1 - Misty Bog",
      "Spyro 3 - Spooky Swamp",
      "Spyro 2 - Magma Cone",
      "Spyro 1 - Wizard Peak",
      "Spyro 3 - Sheila’s Alp",
      "Spyro 1 - Toasty + Gnasty’s World (Gnorc Gnexus)",
      "Spyro 1 - High Caves (PAL)",
      "Spyro 3 - Charmed Ridge",
      "Spyro 2 - Hurricos",
      "Spyro 1 - Night Flight",
      "Spyro 3 - Crystal Islands (Greatest Hits)",
      "Spyro 1 - Icy Flight",
    ]),
    On = {
      subscribe: ue(
        [
          {
            url: "https://soundcloud.com/user-514027535/gnastys-world-twilight-harbor?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Twilight Harbor",
          },
          {
            url: "https://soundcloud.com/user-514027535/dream-weavers-lofty-castle?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Lofty Castle",
          },
          {
            url: "https://soundcloud.com/user-514027535/summer-forest-sunny-beach?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Sunny Beach",
          },
          {
            url: "https://soundcloud.com/user-514027535/artisans-home?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Artisans",
          },
          {
            url: "https://soundcloud.com/user-514027535/sunrise-spring-cloud-spires-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Cloud Spires",
          },
          {
            url: "https://soundcloud.com/user-514027535/magic-crafters-alpine-ridge?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Alpine Ridge",
          },
          {
            url: "https://soundcloud.com/user-514027535/glimmer?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Title Screen + Glimmer",
          },
          {
            url: "https://soundcloud.com/user-514027535/midnight-mountain-sorceresss-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Sorceress’s Lair (Greatest Hits)",
          },
          {
            url: "https://soundcloud.com/user-514027535/peace-keepers-dry-canyon?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Dry Canyon",
          },
          {
            url: "https://soundcloud.com/user-514027535/beast-makers-home?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Beast Makers",
          },
          {
            url: "https://soundcloud.com/user-514027535/autumn-plains-skelos-badlands?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Skelos Badlands",
          },
          {
            url: "https://soundcloud.com/user-514027535/gnastys-world-gnasty-gnorc?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Gnasty Gnorc",
          },
          {
            url: "https://soundcloud.com/user-514027535/autumn-plains-breeze-harbor?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Breeze Harbor (Trolley Trouble)",
          },
          {
            url: "https://soundcloud.com/user-514027535/evening-lake-fireworks-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Fireworks Factory",
          },
          {
            url: "https://soundcloud.com/user-514027535/midday-gardens-icy-peak-2?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Icy Peak",
          },
          {
            url: "https://soundcloud.com/user-514027535/sunrise-spring-home-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Sunrise Spring",
          },
          {
            url: "https://soundcloud.com/user-514027535/evening-lake-scorchs-pit-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Scorch's Pit",
          },
          {
            url: "https://soundcloud.com/user-514027535/midday-gardens-sgt-byrds-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Sgt Byrd’s Base + Enchanted Towers",
          },
          {
            url: "https://soundcloud.com/user-514027535/midnight-mountain-haunted-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Haunted Tomb (Greatest Hits)",
          },
          {
            url: "https://soundcloud.com/user-514027535/magic-crafters-crystal-flight?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Crystal Flight",
          },
          {
            url: "https://soundcloud.com/user-514027535/evening-lake-bentleys-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Bentley’s Outpost",
          },
          {
            url: "https://soundcloud.com/user-514027535/dream-weavers-home?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Dream Weavers",
          },
          {
            url: "https://soundcloud.com/user-514027535/artisans-sunny-flight?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Sunny Flight",
          },
          {
            url: "https://soundcloud.com/user-514027535/midday-gardens-enchanted-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Enchanted Towers (Lost Wolf & Skateboarding)",
          },
          {
            url: "https://soundcloud.com/user-514027535/midday-gardens-country-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Country Speedway (Greatest Hits)",
          },
          {
            url: "https://soundcloud.com/user-514027535/sunrise-spring-sunny-villa-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Sunny Villa",
          },
          {
            url: "https://soundcloud.com/user-514027535/dragon-shores-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Dragon Shores",
          },
          {
            url: "https://soundcloud.com/user-514027535/gnorccove?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Gnorc Cove",
          },
          {
            url: "https://soundcloud.com/user-514027535/summer-forest-crushs-dungeon?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Crush’s Dungeon",
          },
          {
            url: "https://soundcloud.com/user-514027535/midday-gardens-bamboo-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Bamboo Terrace",
          },
          {
            url: "https://soundcloud.com/user-514027535/magic-crafters-home?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Magic Crafters",
          },
          {
            url: "https://soundcloud.com/user-514027535/winter-tundra-cloud-temples-3?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Cloud Temples",
          },
          {
            url: "https://soundcloud.com/user-514027535/winter-tundra-robotica-farms-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Robotica Farms",
          },
          {
            url: "https://soundcloud.com/user-514027535/summer-forest-ocean-speedway?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Ocean Speedway",
          },
          {
            url: "https://soundcloud.com/user-514027535/dream-weavers-haunted-towers?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Haunted Towers",
          },
          {
            url: "https://soundcloud.com/user-514027535/peace-keepers-ice-cavern?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Ice Cavern",
          },
          {
            url: "https://soundcloud.com/user-514027535/magic-crafters-blowhard?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Blowhard",
          },
          {
            url: "https://soundcloud.com/user-514027535/evening-lake-home-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Evening Lake (Greatest Hits)",
          },
          {
            url: "https://soundcloud.com/user-514027535/evening-lake-lost-fleet-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Lost Fleet (Greatest Hits)",
          },
          {
            url: "https://soundcloud.com/user-514027535/midnight-mountain-super-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Super Bonus Round",
          },
          {
            url: "https://soundcloud.com/user-514027535/autumn-plains-gulps-overlook?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Gulp’s Overlook",
          },
          {
            url: "https://soundcloud.com/user-514027535/sunrise-spring-seashell-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Seashell Shore",
          },
          {
            url: "https://soundcloud.com/user-514027535/midnight-mountain-dino-mines-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Dino Mines (Greatest Hits)",
          },
          {
            url: "https://soundcloud.com/user-514027535/artisans-stone-hill?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Stone Hill",
          },
          {
            url: "https://soundcloud.com/user-514027535/beast-makers-metalhead?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Metalhead",
          },
          {
            url: "https://soundcloud.com/user-514027535/evening-lake-honey-speedway-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Honey Speedway (Greatest Hits)",
          },
          {
            url: "https://soundcloud.com/user-514027535/autumn-plains-zephyr?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Zephyr",
          },
          {
            url: "https://soundcloud.com/user-514027535/winter-tundra-canyon-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Canyon Speedway",
          },
          {
            url: "https://soundcloud.com/user-514027535/artisans-town-square?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Town Square",
          },
          {
            url: "https://soundcloud.com/user-514027535/credits-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro Trilogy - Credits",
          },
          {
            url: "https://soundcloud.com/user-514027535/dream-weavers-jacques-game-rip?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Jacques",
          },
          {
            url: "https://soundcloud.com/user-514027535/peace-keepers-dr-shemp?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Dr Shemp",
          },
          {
            url: "https://soundcloud.com/user-514027535/peace-keepers-cliff-town?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Cliff Town",
          },
          {
            url: "https://soundcloud.com/user-514027535/winter-tundra-mystic-marsh?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Mystic Marsh",
          },
          {
            url: "https://soundcloud.com/user-514027535/gnastys-world-gnastys-loot?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Gnasty’s Loot",
          },
          {
            url: "https://soundcloud.com/user-514027535/midday-gardens-spikes-arena-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Spike’s Arena",
          },
          {
            url: "https://soundcloud.com/user-514027535/autumn-plains-breeze-harbor-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Breeze Harbor",
          },
          {
            url: "https://soundcloud.com/user-514027535/sunrise-spring-buzzs-dungeon-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Buzz’s Dungeon",
          },
          {
            url: "https://soundcloud.com/user-514027535/scorch?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Scorch",
          },
          {
            url: "https://soundcloud.com/user-514027535/artisans-dark-hollow?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Dark Hollow",
          },
          {
            url: "https://soundcloud.com/user-514027535/peace-keepers-home?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Peace Keepers",
          },
          {
            url: "https://soundcloud.com/user-514027535/sunrise-spring-molten-crater-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Molten Crater",
          },
          {
            url: "https://soundcloud.com/user-514027535/sunrise-spring-mushroom-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Mushroom Speedway (Greatest Hits)",
          },
          {
            url: "https://soundcloud.com/user-514027535/magic-crafters-high-caves-usa?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - High Caves (NTSC)",
          },
          {
            url: "https://soundcloud.com/user-514027535/autumn-plains-icy-speedway?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Icy Speedway",
          },
          {
            url: "https://soundcloud.com/user-514027535/winter-tundra-metropolis-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Metropolis",
          },
          {
            url: "https://soundcloud.com/user-514027535/autumn-plains-magma-cone-grab?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Magma Cone (Crystal Popcorn)",
          },
          {
            url: "https://soundcloud.com/user-514027535/beast-makers-terrace-village?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Terrace Village",
          },
          {
            url: "https://soundcloud.com/user-514027535/autumn-plains-shady-oasis?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Shady Oasis",
          },
          {
            url: "https://soundcloud.com/user-514027535/midday-gardens-icy-peak-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Icy Peak (Nancy)",
          },
          {
            url: "https://soundcloud.com/user-514027535/summer-forest-aquaria-towers?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Aquaria Towers",
          },
          {
            url: "https://soundcloud.com/user-514027535/midnight-mountain-harbor-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Harbor Speedway",
          },
          {
            url: "https://soundcloud.com/user-514027535/beast-makers-wild-flight?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Wild Flight",
          },
          {
            url: "https://soundcloud.com/user-514027535/winter-tundra-riptos-arena-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Ripto’s Arena (NTSC)",
          },
          {
            url: "https://soundcloud.com/user-514027535/autumn-plains-metro-speedway?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Metro Speedway",
          },
          {
            url: "https://soundcloud.com/user-514027535/midnight-mountain-agent-9s-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Agent 9’s Lab",
          },
          {
            url: "https://soundcloud.com/user-514027535/midday-gardens-home-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Midday Gardens",
          },
          {
            url: "https://soundcloud.com/user-514027535/midnight-mountain-home-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Midnight Mountain",
          },
          {
            url: "https://soundcloud.com/user-514027535/midnight-mountain-desert-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Desert Ruins",
          },
          {
            url: "https://soundcloud.com/user-514027535/spyro-1-opening-theme-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Title Screen",
          },
          {
            url: "https://soundcloud.com/user-514027535/idol-springs?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Idol Springs + Fracture Hills",
          },
          {
            url: "https://soundcloud.com/user-514027535/winter-tundra-cloud-temples-2?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Cloud Temples (Agent Zero)",
          },
          {
            url: "https://soundcloud.com/user-514027535/autumn-plains-crystal-glacier?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Crystal Glacier",
          },
          {
            url: "https://soundcloud.com/user-514027535/summer-forest-colossus-lets?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Colossus (Hockey)",
          },
          {
            url: "https://soundcloud.com/user-514027535/beast-makers-tree-tops?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Tree Tops",
          },
          {
            url: "https://soundcloud.com/user-514027535/spyro-3-opening-sparx-levels-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Title Screen + Sparx Levels",
          },
          {
            url: "https://soundcloud.com/user-514027535/evening-lake-frozen-altars-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Frozen Altars",
          },
          {
            url: "https://soundcloud.com/user-514027535/colossus?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Colossus",
          },
          {
            url: "https://soundcloud.com/user-514027535/beast-makers-misty-bog?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Misty Bog",
          },
          {
            url: "https://soundcloud.com/user-514027535/midday-gardens-spooky-swamp-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Spooky Swamp",
          },
          {
            url: "https://soundcloud.com/user-514027535/autumn-plains-magma-cone?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Magma Cone",
          },
          {
            url: "https://soundcloud.com/user-514027535/magic-crafters-wizard-peak?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Wizard Peak",
          },
          {
            url: "https://soundcloud.com/user-514027535/sunrise-spring-sheilas-alp-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Sheila’s Alp",
          },
          {
            url: "https://soundcloud.com/user-514027535/toasty-gnastys-world-gnorc?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Toasty + Gnasty’s World (Gnorc Gnexus)",
          },
          {
            url: "https://soundcloud.com/user-514027535/magic-crafters-high-caves-eur?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - High Caves (PAL)",
          },
          {
            url: "https://soundcloud.com/user-514027535/evening-lake-charmed-ridge-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Charmed Ridge",
          },
          {
            url: "https://soundcloud.com/user-514027535/summer-forest-hurricos?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 2 - Hurricos",
          },
          {
            url: "https://soundcloud.com/user-514027535/peace-keepers-night-flight?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Night Flight",
          },
          {
            url: "https://soundcloud.com/user-514027535/midnight-mountain-crystal-1?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 3 - Crystal Islands (Greatest Hits)",
          },
          {
            url: "https://soundcloud.com/user-514027535/dream-weavers-icy-flight?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
            answer: "Spyro 1 - Icy Flight",
          },
        ],
        Pn
      ).subscribe,
    ...
    return {
      c() {
        (t = w("meta")),
          ...
          (C = x()),
          H && H.c(),
          (An.title = "Spyro Heardle"),
          M(t, "name", "description"),
          M(
            t,
            "content",
            "Guess the PS1 Spyro song from the intro in as few tries as possible"
          ),
